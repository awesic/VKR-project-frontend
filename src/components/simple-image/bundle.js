                ...
                function t(e) {
                    ...
                    !(function (t, e) {
                        ...
                        (this.data = {
                            ...
                            withBackground:
                                void 0 !== n.withBackground && n.withBackground,
                    ...
                    (n = [
                        {
                            ...
                            value: function () {
                                var t = this,
                                    ...
                                    i = this._make("div", this.CSS.loading),
                                    r = this._make("div", this.CSS.imageHolder),
                                    o = this._make("img"),
                                    a = this._make(
                                        "div",
                                        [this.CSS.input, this.CSS.caption],
                                        {
                                ...
                                return (
                                    (this.nodes.imageHolder = r),
                                    (this.nodes.wrapper = e),
                                    (this.nodes.image = o),
                                    (this.nodes.caption = a),
                                    (this.nodes.loader = i),
                                    (this.nodes.loadButton = n),
                                    (a.dataset.placeholder = "Enter a caption"),
                                    (o.onload = function () {
                                        e.classList.remove(t.CSS.loading),
                                            r.appendChild(o),
                                            e.appendChild(r),
                                            e.appendChild(a),
                                            i.remove(),
                            ...
                            value: function () {
                                ...
                                return (
                                    this.settings.forEach(function (n) {
                                        ...
                                        i.classList.add(t.CSS.settingsButton),
                                            (i.innerHTML = n.icon),
                                            i.addEventListener(
                                                "click",
                                                function () {
                                                    t._toggleTune(n.name),
                                                        i.classList.toggle(
                                                            t.CSS
                                                                .settingsButtonActive
                                                        );
                        ...
                        },
                        {
                            ...
                            value: function () {
                                ...
                                this.settings.forEach(function (e) {
                                    t.nodes.imageHolder.classList.toggle(
                                        t.CSS.imageHolder +
                                            "--" +
                                            e.name.replace(
                                                /([A-Z])/g,
                        ...
                        },
                        {
                            ...
                            set: function (t) {
                                (this._data = Object.assign({}, this.data, t)),
                                    this.nodes.image &&
                                        (this.nodes.image.src = this.data.url),
                                    this.nodes.caption &&
                                        (this.nodes.caption.innerHTML =
                                            this.data.caption);
                            },
                        },
                    ]) && r(e.prototype, n),
